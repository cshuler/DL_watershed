...
Topography         = "DEM_clipped_18.tif"
Soils              = "soil_clipped_18.tif"
Land_Use           = "LU_clipped_18.tif"
...
# Shape Files
Outlet             = "Fagaalu.shp" # it should have same format as in the example
...
# model run settings
Model_Run_period      = "2010 - 2015"# e.g. "1975 - 1980". period to run the simulation from file.cio,
                                     # leave as "" to run whole period where weather data is available
Warm_up_period        = 3            # the number of years for running the model without printing output
