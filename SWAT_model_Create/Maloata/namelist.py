...
Topography         = "DEM_clipped_24.tif"
Soils              = "soil_clipped_24.tif"
Land_Use           = "LU_clipped_24.tif"
...
# Shape Files
Outlet             = "Maloata.shp" # it should have same format as in the example
